...
BMD_CONST REFIID IID_IDeckLinkConfiguration = /* 912F634B-2D4E-40A4-8AAB-8D80B73F1289 */ {0x91, 0x2F, 0x63, 0x4B, 0x2D, 0x4E, 0x40, 0xA4,
                                                                                          0x8A, 0xAB, 0x8D, 0x80, 0xB7, 0x3F, 0x12, 0x89};
BMD_CONST REFIID IID_IDeckLinkEncoderConfiguration = /* 138050E5-C60A-4552-BF3F-0F358049327E */ {
    0x13, 0x80, 0x50, 0xE5, 0xC6, 0x0A, 0x45, 0x52, 0xBF, 0x3F, 0x0F, 0x35, 0x80, 0x49, 0x32, 0x7E};
...
enum _BMDDeckLinkEncoderConfigurationID
{
    ...
    bmdDeckLinkEncoderConfigMPEG4SampleDescription =
        /* 'stsE' */ 0x73747345, // Full MPEG4 sample description (aka SampleEntry of an 'stsd' atom-box). Useful for MediaFoundation,
                                 // QuickTime, MKV and more
    bmdDeckLinkEncoderConfigMPEG4CodecSpecificDesc =
        /* 'esds' */ 0x65736473 // Sample description extensions only (atom stream, each with size and fourCC header). Useful for
                                // AVFoundation, VideoToolbox, MKV and more
};
...
public:
    ...
    virtual HRESULT GetBytes(/* in */ BMDDeckLinkEncoderConfigurationID cfgID, /* out */ void* buffer /* optional */,
