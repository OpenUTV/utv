...
BMD_CONST REFIID IID_IDeckLinkVideoFrameMetadataExtensions_v11_5 = /* D5973DC9-6432-46D0-8F0B-2496F8A1238F */ {
    0xD5, 0x97, 0x3D, 0xC9, 0x64, 0x32, 0x46, 0xD0, 0x8F, 0x0B, 0x24, 0x96, 0xF8, 0xA1, 0x23, 0x8F};
...
enum _BMDDeckLinkFrameMetadataID_v11_5
{
    ...
    bmdDeckLinkFrameMetadataCintelOffsetToApplyHorizontal_v11_5 =
        /* 'otah' */ 0x6F746168, // Horizontal offset (pixels) to be applied to image
    ...
    bmdDeckLinkFrameMetadataCintelHDRGainRed_v11_5 =
        /* 'HGRd' */ 0x48475264, // Red gain parameter to apply to linear data for HDR Combination
    bmdDeckLinkFrameMetadataCintelHDRGainGreen_v11_5 =
        /* 'HGGr' */ 0x48474772, // Green gain parameter to apply to linear data for HDR Combination
    bmdDeckLinkFrameMetadataCintelHDRGainBlue_v11_5 =
        /* 'HGBl' */ 0x4847426C, // Blue gain parameter to apply to linear data for HDR Combination
    ...
    bmdDeckLinkFrameMetadataCintelKeykodeIsInterpolated_v11_5 =
        /* 'kkii' */ 0x6B6B6969 // The keykode for this frame is interpolated from nearby keykodes
};

/* Interface IDeckLinkVideoFrameMetadataExtensions - Optional interface implemented on IDeckLinkVideoFrame to support frame metadata such as
 * HDMI HDR information */
