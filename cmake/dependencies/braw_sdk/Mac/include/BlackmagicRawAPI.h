...
BMD_CONST REFIID IID_IBlackmagicRaw = /* C25C15E2-D1D0-4743-9EA8-F21F69751AF3 */ {0xC2, 0x5C, 0x15, 0xE2, 0xD1, 0xD0, 0x47, 0x43,
                                                                                  0x9E, 0xA8, 0xF2, 0x1F, 0x69, 0x75, 0x1A, 0xF3};
BMD_CONST REFIID IID_IBlackmagicRawFactory = /* 78DEEB84-98C9-434A-B7E5-7AACC2988399 */ {0x78, 0xDE, 0xEB, 0x84, 0x98, 0xC9, 0x43, 0x4A,
                                                                                         0xB7, 0xE5, 0x7A, 0xAC, 0xC2, 0x98, 0x83, 0x99};
BMD_CONST REFIID IID_IBlackmagicRawPipelineIterator = /* 051ED792-3D9D-4ED0-BB1F-3873E08773CB */ {
    0x05, 0x1E, 0xD7, 0x92, 0x3D, 0x9D, 0x4E, 0xD0, 0xBB, 0x1F, 0x38, 0x73, 0xE0, 0x87, 0x73, 0xCB};
BMD_CONST REFIID IID_IBlackmagicRawPipelineDeviceIterator = /* 32D3385F-06EE-4260-82EB-2BABFFFACED8 */ {
    0x32, 0xD3, 0x38, 0x5F, 0x06, 0xEE, 0x42, 0x60, 0x82, 0xEB, 0x2B, 0xAB, 0xFF, 0xFA, 0xCE, 0xD8};
BMD_CONST REFIID IID_IBlackmagicRawOpenGLInteropHelper = /* 86444C8A-4398-4364-9166-7D10F41C315E */ {
    0x86, 0x44, 0x4C, 0x8A, 0x43, 0x98, 0x43, 0x64, 0x91, 0x66, 0x7D, 0x10, 0xF4, 0x1C, 0x31, 0x5E};
BMD_CONST REFIID IID_IBlackmagicRawPipelineDevice = /* 078F1902-C143-4A49-A3C7-3408C755100A */ {
    0x07, 0x8F, 0x19, 0x02, 0xC1, 0x43, 0x4A, 0x49, 0xA3, 0xC7, 0x34, 0x08, 0xC7, 0x55, 0x10, 0x0A};
BMD_CONST REFIID IID_IBlackmagicRawToneCurve = /* 7E40C13D-3575-46B5-B2B7-85DAE1EEFD77 */ {0x7E, 0x40, 0xC1, 0x3D, 0x35, 0x75, 0x46, 0xB5,
                                                                                           0xB2, 0xB7, 0x85, 0xDA, 0xE1, 0xEE, 0xFD, 0x77};
BMD_CONST REFIID IID_IBlackmagicRawConfiguration = /* 267E9866-FB40-4BFB-8BF8-96EA3F7DA36E */ {
    0x26, 0x7E, 0x98, 0x66, 0xFB, 0x40, 0x4B, 0xFB, 0x8B, 0xF8, 0x96, 0xEA, 0x3F, 0x7D, 0xA3, 0x6E};
BMD_CONST REFIID IID_IBlackmagicRawConfigurationEx = /* ACE9078F-ABA0-4B26-A954-EDA108DADA5A */ {
    0xAC, 0xE9, 0x07, 0x8F, 0xAB, 0xA0, 0x4B, 0x26, 0xA9, 0x54, 0xED, 0xA1, 0x08, 0xDA, 0xDA, 0x5A};
BMD_CONST REFIID IID_IBlackmagicRawClipGeometry = /* 22717196-36AE-4B8A-B5CC-24292F9660F0 */ {
    0x22, 0x71, 0x71, 0x96, 0x36, 0xAE, 0x4B, 0x8A, 0xB5, 0xCC, 0x24, 0x29, 0x2F, 0x96, 0x60, 0xF0};
BMD_CONST REFIID IID_IBlackmagicRawResourceManager = /* 3C5C3C4A-812C-4AF0-99F0-06C6E197C189 */ {
    0x3C, 0x5C, 0x3C, 0x4A, 0x81, 0x2C, 0x4A, 0xF0, 0x99, 0xF0, 0x06, 0xC6, 0xE1, 0x97, 0xC1, 0x89};
BMD_CONST REFIID IID_IBlackmagicRawMetadataIterator = /* F85AE78D-5DC2-40BC-8C1D-D0D805523ADA */ {
    0xF8, 0x5A, 0xE7, 0x8D, 0x5D, 0xC2, 0x40, 0xBC, 0x8C, 0x1D, 0xD0, 0xD8, 0x05, 0x52, 0x3A, 0xDA};
BMD_CONST REFIID IID_IBlackmagicRawClipProcessingAttributes = /* 7E5806E1-40B3-4DAD-8D03-5E294E65AC61 */ {
    0x7E, 0x58, 0x06, 0xE1, 0x40, 0xB3, 0x4D, 0xAD, 0x8D, 0x03, 0x5E, 0x29, 0x4E, 0x65, 0xAC, 0x61};
BMD_CONST REFIID IID_IBlackmagicRawFrameProcessingAttributes = /* 5F7C5C0F-7138-445A-9D0D-6111B6409D17 */ {
    0x5F, 0x7C, 0x5C, 0x0F, 0x71, 0x38, 0x44, 0x5A, 0x9D, 0x0D, 0x61, 0x11, 0xB6, 0x40, 0x9D, 0x17};
BMD_CONST REFIID IID_IBlackmagicRawPost3DLUT = /* 86052BC4-0231-48C6-B3C8-C771112AAD68 */ {0x86, 0x05, 0x2B, 0xC4, 0x02, 0x31, 0x48, 0xC6,
                                                                                           0xB3, 0xC8, 0xC7, 0x71, 0x11, 0x2A, 0xAD, 0x68};
BMD_CONST REFIID IID_IBlackmagicRawProcessedImage = /* D87A0F72-A883-42BB-8488-0089411C5035 */ {
    0xD8, 0x7A, 0x0F, 0x72, 0xA8, 0x83, 0x42, 0xBB, 0x84, 0x88, 0x00, 0x89, 0x41, 0x1C, 0x50, 0x35};
BMD_CONST REFIID IID_IBlackmagicRawJob = /* 34C05ACF-7118-45EA-8B71-887E0515395D */ {0x34, 0xC0, 0x5A, 0xCF, 0x71, 0x18, 0x45, 0xEA,
                                                                                     0x8B, 0x71, 0x88, 0x7E, 0x05, 0x15, 0x39, 0x5D};
BMD_CONST REFIID IID_IBlackmagicRawReadJobHints = /* 1069F99C-A4E2-415A-91C4-5E0CE0C6AF77 */ {
    0x10, 0x69, 0xF9, 0x9C, 0xA4, 0xE2, 0x41, 0x5A, 0x91, 0xC4, 0x5E, 0x0C, 0xE0, 0xC6, 0xAF, 0x77};
BMD_CONST REFIID IID_IBlackmagicRawCallback = /* E9F98FAC-33DB-4A65-BB94-8A82B027AED0 */ {0xE9, 0xF9, 0x8F, 0xAC, 0x33, 0xDB, 0x4A, 0x65,
                                                                                          0xBB, 0x94, 0x8A, 0x82, 0xB0, 0x27, 0xAE, 0xD0};
BMD_CONST REFIID IID_IBlackmagicRawClipAudio = /* 76D4ACED-E0D6-45BB-B547-56B7435B2A1D */ {0x76, 0xD4, 0xAC, 0xED, 0xE0, 0xD6, 0x45, 0xBB,
                                                                                           0xB5, 0x47, 0x56, 0xB7, 0x43, 0x5B, 0x2A, 0x1D};
BMD_CONST REFIID IID_IBlackmagicRawFilesystem = /* 48640A3F-DC26-4CF9-B540-1CD8087986DD */ {0x48, 0x64, 0x0A, 0x3F, 0xDC, 0x26, 0x4C, 0xF9,
                                                                                            0xB5, 0x40, 0x1C, 0xD8, 0x08, 0x79, 0x86, 0xDD};
BMD_CONST REFIID IID_IBlackmagicRawFile = /* 9D0B46AB-C9DC-4BFB-8DDF-5E5A8F19BEFC */ {0x9D, 0x0B, 0x46, 0xAB, 0xC9, 0xDC, 0x4B, 0xFB,
                                                                                      0x8D, 0xDF, 0x5E, 0x5A, 0x8F, 0x19, 0xBE, 0xFC};
BMD_CONST REFIID IID_IBlackmagicRawClipAccelerometerMotion = /* 983AACBB-F469-40C9-AA81-345B0B7CCD05 */ {
    0x98, 0x3A, 0xAC, 0xBB, 0xF4, 0x69, 0x40, 0xC9, 0xAA, 0x81, 0x34, 0x5B, 0x0B, 0x7C, 0xCD, 0x05};
BMD_CONST REFIID IID_IBlackmagicRawClipGyroscopeMotion = /* 00543A2C-FDED-4C79-A60C-A460415F0296 */ {
    0x00, 0x54, 0x3A, 0x2C, 0xFD, 0xED, 0x4C, 0x79, 0xA6, 0x0C, 0xA4, 0x60, 0x41, 0x5F, 0x02, 0x96};
BMD_CONST REFIID IID_IBlackmagicRawClipPDAFData = /* AAE71534-F951-4062-B6A9-69B8808CD267 */ {
    0xAA, 0xE7, 0x15, 0x34, 0xF9, 0x51, 0x40, 0x62, 0xB6, 0xA9, 0x69, 0xB8, 0x80, 0x8C, 0xD2, 0x67};
BMD_CONST REFIID IID_IBlackmagicRawAudioBuffer = /* 6FCA661F-35AA-469A-AFCE-3012B40760CC */ {
    0x6F, 0xCA, 0x66, 0x1F, 0x35, 0xAA, 0x46, 0x9A, 0xAF, 0xCE, 0x30, 0x12, 0xB4, 0x07, 0x60, 0xCC};
BMD_CONST REFIID IID_IBlackmagicRawFrame = /* A500B253-1808-4EF2-8692-D23C692404EA */ {0xA5, 0x00, 0xB2, 0x53, 0x18, 0x08, 0x4E, 0xF2,
                                                                                       0x86, 0x92, 0xD2, 0x3C, 0x69, 0x24, 0x04, 0xEA};
BMD_CONST REFIID IID_IBlackmagicRawFrameEx = /* F8C6C374-D7FB-4BD3-AD0B-C533464FF450 */ {0xF8, 0xC6, 0xC3, 0x74, 0xD7, 0xFB, 0x4B, 0xD3,
                                                                                         0xAD, 0x0B, 0xC5, 0x33, 0x46, 0x4F, 0xF4, 0x50};
BMD_CONST REFIID IID_IBlackmagicRawFrameMultiVideo = /* 96AE962B-30A4-4904-813D-A9EFFE5953C2 */ {
    0x96, 0xAE, 0x96, 0x2B, 0x30, 0xA4, 0x49, 0x04, 0x81, 0x3D, 0xA9, 0xEF, 0xFE, 0x59, 0x53, 0xC2};
BMD_CONST REFIID IID_IBlackmagicRawManualDecoderFlow1 = /* 278815A6-A3C1-47C7-A0A6-6754DEAE5E7A */ {
    0x27, 0x88, 0x15, 0xA6, 0xA3, 0xC1, 0x47, 0xC7, 0xA0, 0xA6, 0x67, 0x54, 0xDE, 0xAE, 0x5E, 0x7A};
BMD_CONST REFIID IID_IBlackmagicRawManualDecoderFlow2 = /* DBEC4C39-B4C2-4A65-AA8C-2B3C7F4777E3 */ {
    0xDB, 0xEC, 0x4C, 0x39, 0xB4, 0xC2, 0x4A, 0x65, 0xAA, 0x8C, 0x2B, 0x3C, 0x7F, 0x47, 0x77, 0xE3};
BMD_CONST REFIID IID_IBlackmagicRawClip = /* A2910203-787B-4BF2-A374-B1A459E2D351 */ {0xA2, 0x91, 0x02, 0x03, 0x78, 0x7B, 0x4B, 0xF2,
                                                                                      0xA3, 0x74, 0xB1, 0xA4, 0x59, 0xE2, 0xD3, 0x51};
BMD_CONST REFIID IID_IBlackmagicRawClipEx = /* 7DB60B13-6BB2-49DE-9A24-AA14A9F3CA6B */ {0x7D, 0xB6, 0x0B, 0x13, 0x6B, 0xB2, 0x49, 0xDE,
                                                                                        0x9A, 0x24, 0xAA, 0x14, 0xA9, 0xF3, 0xCA, 0x6B};
BMD_CONST REFIID IID_IBlackmagicRawClipMultiVideo = /* B868316D-18E6-4792-ACF4-D7F25CB5CBB6 */ {
    0xB8, 0x68, 0x31, 0x6D, 0x18, 0xE6, 0x47, 0x92, 0xAC, 0xF4, 0xD7, 0xF2, 0x5C, 0xB5, 0xCB, 0xB6};
BMD_CONST REFIID IID_IBlackmagicRawClipImmersiveVideo = /* 47D287A7-9148-4659-BFCF-C767A089A200 */ {
    0x47, 0xD2, 0x87, 0xA7, 0x91, 0x48, 0x46, 0x59, 0xBF, 0xCF, 0xC7, 0x67, 0xA0, 0x89, 0xA2, 0x00};
BMD_CONST REFIID IID_IBlackmagicRawClipResolutions = /* C63C290F-525B-4EBE-AB56-87B010CACE19 */ {
    0xC6, 0x3C, 0x29, 0x0F, 0x52, 0x5B, 0x4E, 0xBE, 0xAB, 0x56, 0x87, 0xB0, 0x10, 0xCA, 0xCE, 0x19};
...
enum _BlackmagicRawClipProcessingAttribute
{
    ...
    blackmagicRawClipProcessingAttributeLensShadingEnable = /* 'shde' */ 0x73686465,              // u16
    blackmagicRawClipProcessingAttributeLensDistortionCorrectionEnable = /* 'dice' */ 0x64696365, // u16
    blackmagicRawClipProcessingAttributeLensChromaticAberrationCorrectionEnable = /* 'cace' */ 0x63616365 // u16
};
...
{
public:
    virtual HRESULT OpenClip(/* in */ CFStringRef filePath, /* out */ IBlackmagicRawClip** clip) = 0;
    virtual HRESULT OpenClipWithGeometry(/* in */ CFStringRef filePath, /* in */ IBlackmagicRawClipGeometry* geometry,
                                         /* out */ IBlackmagicRawClip** clip) = 0;
    virtual HRESULT OpenClipFromFile(/* in */ IBlackmagicRawFile* brawFile, /* out */ IBlackmagicRawClip** clip) = 0;
    virtual HRESULT OpenClipFromFileWithGeometry(/* in */ IBlackmagicRawFile* brawFile, /* in */ IBlackmagicRawClipGeometry* geometry,
                                                 /* out */ IBlackmagicRawClip** clip) = 0;
    virtual HRESULT SetCallback(/* in */ IBlackmagicRawCallback* callback) = 0;
    virtual HRESULT PreparePipeline(/* in */ BlackmagicRawPipeline pipeline, /* in */ void* pipelineContext,
                                    /* in */ void* pipelineCommandQueue,
                                    /* in */ void* userData /* optional */) = 0; // Asynchronously prepares the current pipeline
    virtual HRESULT PreparePipelineForDevice(/* in */ IBlackmagicRawPipelineDevice* pipelineDevice,
                                             /* in */ void* userData /* optional */) = 0; // Asynchronously prepares the current pipeline
...
public:
    ...
    virtual HRESULT CreatePipelineIterator(/* in */ BlackmagicRawInterop interop,
                                           /* out */ IBlackmagicRawPipelineIterator** pipelineIterator) = 0;
    virtual HRESULT CreatePipelineDeviceIterator(/* in */ BlackmagicRawPipeline pipeline, /* in */ BlackmagicRawInterop interop,
...
public:
    ...
    virtual HRESULT SetImage(/* in */ IBlackmagicRawProcessedImage* processedImage, /* out */ uint32_t* openGLTextureName,
                             /* out */ int32_t* openGLTextureTarget) = 0;
...
public:
    ...
    virtual HRESULT GetUniqueIdentifier(/* out */ uint64_t* uniqueIdentifier) = 0;
    virtual HRESULT GetInterop(/* out */ BlackmagicRawInterop* interop) = 0;
    ...
    virtual HRESULT GetSupportedResourceFormats(/* out */ BlackmagicRawResourceFormat* array /* optional */,
                                                /* in, out */ uint32_t* arrayElementCount /* optional */) = 0;
...
{
public:
    virtual HRESULT GetToneCurve(
        /* in */ CFStringRef cameraType, /* in */ CFStringRef gamma, /* in */ uint16_t gen /* Color science gen */,
        /* out */ float* contrast, /* out */ float* saturation, /* out */ float* midpoint, /* out */ float* highlights,
        /* out */ float* shadows, /* out */ float* blackLevel, /* out */ float* whiteLevel,
        /* out */ uint16_t* videoBlackLevel) = 0; // Query tone curve parameters for a specific camera and gamma. These are only currently
                                                  // available on Gamut: Blackmagic Design, Gamma: Blackmagic Design Film, Blackmagic Design
                                                  // Extended Video, Blackmagic Design Custom. Note: Custom gamma can define a tone curve
                                                  // per clip, see BlackmagicRawClipProcessingAttributes::GetToneCurveForCustomGamma()
    virtual HRESULT
    EvaluateToneCurve(/* in */ CFStringRef cameraType, /* in */ uint16_t gen, /* in */ float contrast, /* in */ float saturation,
                      /* in */ float midpoint, /* in */ float highlights, /* in */ float shadows, /* in */ float blackLevel,
                      /* in */ float whiteLevel, /* in */ uint16_t videoBlackLevel, /* out */ float* array,
                      /* in */ uint32_t arrayElementCount) = 0; // Evaluates tone curve, returned buffer can be used to visualise curve
...
public:
    virtual HRESULT
    SetPipeline(/* in */ BlackmagicRawPipeline pipeline /* changing pipeline will cause the default resource manager to be re-created */,
                /* in */ void* pipelineContext, /* in */ void* pipelineCommandQueue) = 0;
    virtual HRESULT GetPipeline(/* out */ BlackmagicRawPipeline* pipeline /* optional */,
                                /* out */ void** pipelineContextOut /* optional */,
                                /* out */ void** pipelineCommandQueueOut /* optional */) = 0;
    virtual HRESULT IsPipelineSupported(/* in */ BlackmagicRawPipeline pipeline,
                                        /* out */ bool* pipelineSupported) = 0; // Verifies relevant hardware/DLLs are available
    ...
    virtual HRESULT
    SetWriteMetadataPerFrame(/* in */ bool writePerFrame) = 0; // if true, frame metadata will be written to only the relevant frame
...
public:
    ...
    virtual HRESULT
    SetResourceManager(/* in */ IBlackmagicRawResourceManager*
                           resourceManager /* setting null will restore the default resource manager */) = 0; // Set to NULL to return to
                                                                                                              // default resource manager
    virtual HRESULT GetInstructionSet(/* out */ BlackmagicRawInstructionSet* instructionSet) = 0;
    virtual HRESULT SetInstructionSet(/* in */ BlackmagicRawInstructionSet instructionSet) = 0;
    virtual HRESULT GetSizeLimit(/* out */ BlackmagicRawSizeLimit* sizeLimit, /* out */ uint32_t* sizeLimitWidth,
                                 /* out */ uint32_t* sizeLimitHeight) = 0;
    virtual HRESULT SetSizeLimit(/* in */ BlackmagicRawSizeLimit sizeLimit, /* in */ uint32_t sizeLimitWidth,
                                 /* in */ uint32_t sizeLimitHeight) = 0;
...
{
public:
    virtual HRESULT CreateResource(/* in */ void* context, /* in */ void* commandQueue, /* in */ uint32_t sizeBytes,
                                   /* in */ BlackmagicRawResourceType type, /* in */ BlackmagicRawResourceUsage usage,
                                   /* out */ void** resource) = 0;
    virtual HRESULT ReleaseResource(/* in */ void* context, /* in */ void* commandQueue, /* in */ void* resource,
                                    /* in */ BlackmagicRawResourceType type) = 0;
    virtual HRESULT CopyResource(/* in */ void* context, /* in */ void* commandQueue, /* in */ void* source,
                                 /* in */ BlackmagicRawResourceType sourceType, /* in */ void* destination,
                                 /* in */ BlackmagicRawResourceType destinationType, /* in */ uint32_t sizeBytes,
                                 /* in */ bool copyAsync) = 0; // Utility function, not called by the API
    virtual HRESULT GetResourceHostPointer(/* in */ void* context, /* in */ void* commandQueue, /* in */ void* resource,
                                           /* in */ BlackmagicRawResourceType resourceType,
                                           /* out */ void** hostPointer) = 0; // Utility function, not called by the API
...
public:
    ...
    virtual HRESULT GetClipAttributeRange(/* in */ BlackmagicRawClipProcessingAttribute attribute, /* out */ Variant* valueMin,
                                          /* out */ Variant* valueMax, /* out */ bool* isReadOnly) = 0;
    virtual HRESULT GetClipAttributeList(/* in */ BlackmagicRawClipProcessingAttribute attribute, /* out */ Variant* array /* optional */,
                                         /* out */ uint32_t* arrayElementCount /* optional */, /* out */ bool* isReadOnly) = 0;
    virtual HRESULT GetISOList(/* out */ uint32_t* array /* optional */, /* in, out */ uint32_t* arrayElementCount /* optional */,
                               /* out */ bool* isReadOnly) = 0;
    virtual HRESULT GetPost3DLUT(/* out */ IBlackmagicRawPost3DLUT** lut) = 0;
    virtual HRESULT GetSidecarPost3DLUT(/* out */ IBlackmagicRawPost3DLUT** lut) = 0;
    virtual HRESULT SetSidecarPost3DLUT(/* in */ CFStringRef name, /* in */ CFStringRef title, /* in */ uint16_t size,
                                        /* in */ Variant* data) = 0;
    virtual HRESULT GetEmbeddedPost3DLUT(/* out */ IBlackmagicRawPost3DLUT** lut) = 0;
    virtual HRESULT SetEmbeddedPost3DLUT(/* in */ CFStringRef name, /* in */ CFStringRef title, /* in */ uint16_t size,
                                         /* in */ Variant* data) = 0;
...
public:
    ...
    virtual HRESULT GetFrameAttributeRange(/* in */ BlackmagicRawFrameProcessingAttribute attribute, /* out */ Variant* valueMin,
                                           /* out */ Variant* valueMax, /* out */ bool* isReadOnly) = 0;
    virtual HRESULT GetFrameAttributeList(/* in */ BlackmagicRawFrameProcessingAttribute attribute, /* out */ Variant* array /* optional */,
                                          /* out */ uint32_t* arrayElementCount /* optional */, /* out */ bool* isReadOnly) = 0;
    virtual HRESULT GetISOList(/* out */ uint32_t* array /* optional */, /* in, out */ uint32_t* arrayElementCount /* optional */,
                               /* out */ bool* isReadOnly) = 0;
...
public:
    ...
    virtual HRESULT GetResourceGPU(/* in */ void* context, /* in */ void* commandQueue, /* out */ BlackmagicRawResourceType* type,
                                   /* out */ void** resource) = 0;
    virtual HRESULT GetResourceCPU(/* out */ void** resource) = 0;
    virtual HRESULT GetResourceSizeBytes(/* out */ uint32_t* sizeBytes) = 0;
    virtual HRESULT WriteCubeFile(/* in */ CFStringRef filePath) = 0;
    virtual HRESULT WriteCubeToFile(/* in */ IBlackmagicRawFile* cubeFile) = 0;
...
protected:
    virtual ~IBlackmagicRawReadJobHints() {} // call Release method to drop reference count
};
...
public:
    ...
    virtual void ReadAudioComplete(/* in */ IBlackmagicRawJob* job, /* in */ HRESULT result,
                                   /* in */ IBlackmagicRawAudioBuffer* audioBuffer) = 0;
    virtual void DecodeComplete(/* in */ IBlackmagicRawJob* job, /* in */ HRESULT result) = 0;
    virtual void ProcessComplete(/* in */ IBlackmagicRawJob* job, /* in */ HRESULT result,
    ...
    virtual void SidecarMetadataParseWarning(/* in */ IBlackmagicRawClip* clip, /* in */ CFStringRef fileName, /* in */ uint32_t lineNumber,
                                             /* in */ CFStringRef info) = 0; // offending line will be ignored
    virtual void SidecarMetadataParseError(/* in */ IBlackmagicRawClip* clip, /* in */ CFStringRef fileName, /* in */ uint32_t lineNumber,
                                           /* in */ CFStringRef info) = 0; // entire file will be ignored
...
public:
    ...
    virtual HRESULT GetAudioSamples(/* in */ int64_t sampleFrameIndex, /* in */ void* buffer, /* in */ uint32_t bufferSizeBytes,
                                    /* in */ uint32_t maxSampleCount, /* out */ uint32_t* samplesRead /* optional */,
                                    /* out */ uint32_t* bytesRead /* optional */) = 0;

protected:
    virtual ~IBlackmagicRawClipAudio() {} // call Release method to drop reference count
};

/* Interface IBlackmagicRawFilesystem - Provides filesystem operations */

class BMD_PUBLIC IBlackmagicRawFilesystem : public IUnknown
{
public:
    virtual HRESULT OpenCompanionFile(/* in */ IBlackmagicRawFile* parentFile, /* in */ CFStringRef fileName,
                                      /* out */ IBlackmagicRawFile** fileOut) = 0;
    virtual HRESULT CreateCompanionFile(/* in */ IBlackmagicRawFile* parentFile, /* in */ CFStringRef fileName,
                                        /* in */ bool replaceExisting, /* out */ IBlackmagicRawFile** fileOut) = 0;

protected:
    virtual ~IBlackmagicRawFilesystem() {} // call Release method to drop reference count
};

/* Interface IBlackmagicRawFile - Provides access to a file */

class BMD_PUBLIC IBlackmagicRawFile : public IUnknown
{
public:
    virtual HRESULT GetFilesystem(/* out */ IBlackmagicRawFilesystem** filesystemOut) = 0;
    virtual HRESULT GetFileName(/* out */ CFStringRef* fileName) = 0;
    virtual HRESULT SetFileLength(/* in */ uint64_t fileLength) = 0;
    virtual HRESULT GetFileLength(/* out */ uint64_t* fileLength) = 0;
    virtual HRESULT ReadV(/* in */ BmdIoVec* buffers, /* in */ uint32_t bufferCount, /* in */ uint64_t fileOffset,
                          /* out */ uint64_t* bytesRead) = 0;
    virtual HRESULT WriteV(/* in */ BmdIoVec* buffers, /* in */ uint32_t bufferCount, /* in */ uint64_t fileOffset,
                           /* out */ uint64_t* bytesWritten) = 0;
    virtual HRESULT GetPreferredIoAlignment(/* out */ uint32_t* alignment) = 0;
    virtual HRESULT FlushWrites(void) = 0;
    virtual HRESULT CommitFile(void) = 0;

protected:
    virtual ~IBlackmagicRawFile() {} // call Release method to drop reference count
};
...
public:
    ...
    virtual HRESULT GetSampleRange(/* in */ uint64_t sampleStartIndex, /* in */ uint32_t sampleCount, /* out */ float* samples,
                                   /* out */ uint32_t* sampleCountOut) = 0;
...
public:
    ...
    virtual HRESULT GetSampleImages(/* in */ uint64_t sampleIndex, /* out */ uint8_t* leftSampleImageDataOut,
                                    /* out */ uint8_t* rightSampleImageDataOut, /* in */ uint32_t sampleImageDataSize) = 0;

protected:
    virtual ~IBlackmagicRawClipPDAFData() {} // call Release method to drop reference count
};

/* Interface IBlackmagicRawAudioBuffer - Audio buffer */

class BMD_PUBLIC IBlackmagicRawAudioBuffer : public IUnknown
{
public:
    virtual HRESULT GetAudioFormat(/* out */ BlackmagicRawAudioFormat* format) = 0;
    virtual HRESULT GetAudioBitDepth(/* out */ uint32_t* bitDepth) = 0;
    ...
    virtual HRESULT GetAudioSampleRate(/* out */ uint32_t* sampleRate) = 0;
    virtual HRESULT GetAudioSampleCount(/* out */ uint64_t* sampleCount) = 0;
    virtual HRESULT GetAudioSamples(/* in */ void** buffer, /* in */ uint32_t* bufferSizeBytes) = 0;

protected:
    virtual ~IBlackmagicRawAudioBuffer() {} // call Release method to drop reference count
};
...
public:
    ...
    virtual HRESULT SetMetadata(/* in */ CFStringRef key,
                                /* in */ Variant* value) = 0; // To clear metadata to movie original, set value to NULL. This data is not
                                                              // saved to disk until SaveSideCar() is called
    virtual HRESULT
    CloneFrameProcessingAttributes(/* out */ IBlackmagicRawFrameProcessingAttributes**
                                       frameProcessingAttributes) = 0; // creates object with current frame processing attributes
    ...
    virtual HRESULT CreateJobDecodeAndProcessFrame(
        /* in */ IBlackmagicRawClipProcessingAttributes* clipProcessingAttributes /* optionally override clipProcessingAttributes */,
        /* in */ IBlackmagicRawFrameProcessingAttributes* frameProcessingAttributes /* optionally override frameProcessingAttributes */,
...
{
public:
    virtual HRESULT PopulateFrameStateBuffer(
        /* in */ IBlackmagicRawFrame* frame,
        /* in */ IBlackmagicRawClipProcessingAttributes* clipProcessingAttributes /* optionally override clipProcessingAttributes */,
        /* in */ IBlackmagicRawFrameProcessingAttributes* frameProcessingAttributes /* optionally override frameProcessingAttributes */,
        /* out */ void* frameState, /* in */ uint32_t frameStateSizeBytes) = 0;
    ...
    virtual HRESULT CreateJobDecode(/* in */ void* frameStateBufferCPU, /* in */ void* bitStreamBufferCPU, /* in */ void* decodedBufferCPU,
                                    /* out */ IBlackmagicRawJob** job) = 0;
    virtual HRESULT CreateJobProcess(/* in */ void* frameStateBufferCPU, /* in */ void* decodedBufferCPU, /* in */ void* processedBufferCPU,
                                     /* in */ void* post3DLUTBufferCPU, /* out */ IBlackmagicRawJob** job) = 0;
...
public:
    ...
    virtual HRESULT CreateJobDecode(/* in */ void* frameStateBufferCPU, /* in */ void* bitStreamBufferCPU, /* in */ void* decodedBufferCPU,
                                    /* out */ IBlackmagicRawJob** job) = 0;
    virtual HRESULT
    CreateJobProcess(/* in */ void* context, /* in */ void* commandQueue, /* in */ void* frameStateBufferCPU,
                     /* in */ void* decodedBufferGPU, /* in */ void* workingBufferGPU /* additional working buffer */,
                     /* in */ void* processedBufferGPU, /* in */ void* post3DLUTBufferGPU,
                     /* out */ IBlackmagicRawJob** job) = 0; // Create a job to process a frame. This is performed on the specified GPU.
                                                             // After this process is complete a final processed image will be provided via
                                                             // a OnProcessComplete() callback
...
public:
    ...
    virtual HRESULT
    CloneClipProcessingAttributes(/* out */ IBlackmagicRawClipProcessingAttributes**
                                      clipProcessingAttributes) = 0; // creates object with current clip processing attributes
    ...
    virtual HRESULT GetSidecarFileAttached(/* out */ bool* isSidecarFileAttached) = 0; // Check for successfully parsed sidecar file, which
                                                                                       // is automatically loaded upon opening of a clip
    ...
    virtual HRESULT CreateJobReadAudio(/* in */ uint64_t sampleIndex, /* in */ uint64_t maxSampleCount,
                                       /* out */ IBlackmagicRawJob** job) = 0; // Create a job to read audio samples
    virtual HRESULT CreateJobTrim(/* in */ CFStringRef filePath, /* in */ uint64_t frameIndex, /* in */ uint64_t frameCount,
                                  /* in */ IBlackmagicRawClipProcessingAttributes* clipProcessingAttributes /* optional */,
                                  /* in */ IBlackmagicRawFrameProcessingAttributes* frameProcessingAttributes /* optional */,
                                  /* out */ IBlackmagicRawJob** job) = 0;
    virtual HRESULT CreateJobTrimToFile(/* in */ IBlackmagicRawFile* destinationFile, /* in */ uint64_t frameIndex,
                                        /* in */ uint64_t frameCount,
                                        /* in */ IBlackmagicRawClipProcessingAttributes* clipProcessingAttributes /* optional */,
                                        /* in */ IBlackmagicRawFrameProcessingAttributes* frameProcessingAttributes /* optional */,
                                        /* out */ IBlackmagicRawJob** job) = 0;
...
public:
    ...
    virtual HRESULT CreateJobReadFrame(/* in */ uint64_t frameIndex, /* out */ void* bitStream /* optional */,
                                       /* in */ uint32_t bitStreamSizeBytes /* optional */, /* out */ IBlackmagicRawJob** job) = 0;
    virtual HRESULT CreateJobTrim(/* in */ CFStringRef filePath, /* in */ uint64_t frameIndex, /* in */ uint64_t frameCount,
                                  /* in */ uint32_t frameStep, /* in */ float frameRate /* optional */,
                                  /* in */ IBlackmagicRawClipProcessingAttributes* clipProcessingAttributes /* optional */,
                                  /* in */ IBlackmagicRawFrameProcessingAttributes* frameProcessingAttributes /* optional */,
                                  /* out */ IBlackmagicRawJob** job) = 0;
    virtual HRESULT CreateJobTrimToFile(/* in */ IBlackmagicRawFile* destinationFile, /* in */ uint64_t frameIndex,
                                        /* in */ uint64_t frameCount, /* in */ uint32_t frameStep, /* in */ float frameRate /* optional */,
                                        /* in */ IBlackmagicRawClipProcessingAttributes* clipProcessingAttributes /* optional */,
                                        /* in */ IBlackmagicRawFrameProcessingAttributes* frameProcessingAttributes /* optional */,
                                        /* out */ IBlackmagicRawJob** job) = 0;
    virtual HRESULT QueryTimecodeInfo(/* out */ uint32_t* baseFrameIndex, /* out */ bool* isDropFrameTimecode) = 0;
    virtual HRESULT GetFrameImageOffsetAndSize(/* in */ uint64_t frameIndex, /* out */ uint32_t* imageSizeBytes,
                                               /* out */ uint64_t* imageOffsetBytes, /* out */ uint32_t* fileIndex) = 0;
    virtual HRESULT GetAudioChunkInfo(/* in */ uint64_t sampleIndex, /* out */ uint32_t* audioChunkSizeBytesOut,
                                      /* out */ uint64_t* audioChunkOffsetBytesOut, /* out */ uint64_t* audioChunkSampleCountOut,
                                      /* out */ uint64_t* audioChunkStartSampleIndexOut) = 0;
...
public:
    ...
    virtual HRESULT CreateJobReadFrame(/* in */ uint32_t videoTrackIndex, /* in */ uint64_t frameIndex,
                                       /* out */ IBlackmagicRawJob** job) = 0; // Create a job o read a frame
    virtual HRESULT GetBitStreamSizeBytes(/* in */ uint32_t videoTrackIndex, /* in */ uint64_t frameIndex,
                                          /* out */ uint32_t* bitStreamSizeBytes) = 0;
    virtual HRESULT CreateJobReadFrameEx(/* in */ uint32_t videoTrackIndex, /* in */ uint64_t frameIndex,
                                         /* out */ void* bitStream /* optional */, /* in */ uint32_t bitStreamSizeBytes /* optional */,
                                         /* out */ IBlackmagicRawJob** job) = 0;
    virtual HRESULT GetFrameImageOffsetAndSize(/* in */ uint32_t videoTrackIndex, /* in */ uint64_t frameIndex,
                                               /* out */ uint32_t* imageSizeBytes, /* out */ uint64_t* imageOffsetBytes,
                                               /* out */ uint32_t* fileIndex) = 0;
...
{
public:
    virtual HRESULT CreateJobImmersiveReadFrame(/* in */ BlackmagicRawImmersiveVideoTrack videoTrack, /* in */ uint64_t frameIndex,
                                                /* out */ IBlackmagicRawJob** job) = 0; // Create a job to read a frame
    virtual HRESULT GetImmersiveBitStreamSizeBytes(/* in */ BlackmagicRawImmersiveVideoTrack videoTrack, /* in */ uint64_t frameIndex,
                                                   /* out */ uint32_t* bitStreamSizeBytes) = 0;
    virtual HRESULT CreateJobImmersiveReadFrameEx(/* in */ BlackmagicRawImmersiveVideoTrack videoTrack, /* in */ uint64_t frameIndex,
                                                  /* out */ void* bitStream /* optional */,
                                                  /* in */ uint32_t bitStreamSizeBytes /* optional */,
                                                  /* out */ IBlackmagicRawJob** job) = 0;
...
public:
    ...
    virtual HRESULT GetResolution(/* in */ uint32_t resolutionIndex, /* out */ uint32_t* resolutionWidthPixels,
                                  /* out */ uint32_t* resolutionHeightPixels) = 0;
    virtual HRESULT GetRecordedResolution(/* in */ uint32_t resolutionIndex, /* out */ uint32_t* recordedResolutionWidthPixels,
                                          /* out */ uint32_t* recordedResolutionHeightPixels) = 0;
    virtual HRESULT GetClosestResolutionForScale(/* in */ BlackmagicRawResolutionScale resolutionScale,
                                                 /* out */ uint32_t* resolutionWidthPixels, /* out */ uint32_t* resolutionHeightPixels) = 0;
    virtual HRESULT GetClosestScaleForResolution(/* in */ uint32_t resolutionWidthPixels, /* in */ uint32_t resolutionHeightPixels,
...
extern "C"
{
    ...
    BMD_PUBLIC IBlackmagicRawFactory* CreateBlackmagicRawFactoryInstanceFromIdentifier(/* in */ CFStringRef identifier);
    BMD_PUBLIC HRESULT VariantInit(/* in */ Variant* variant);
    BMD_PUBLIC HRESULT VariantClear(/* in */ Variant* variant);
    BMD_PUBLIC SafeArray* SafeArrayCreate(/* in */ BlackmagicRawVariantType variantType, /* in */ uint32_t dimensions,
                                          /* in */ SafeArrayBound* safeArrayBound);
