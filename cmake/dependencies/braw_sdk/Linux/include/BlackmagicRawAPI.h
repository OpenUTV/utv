...
{
public:
    virtual HRESULT OpenClip(/* in */ const char* filePath, /* out */ IBlackmagicRawClip** clip) = 0;
    virtual HRESULT OpenClipWithGeometry(/* in */ const char* filePath, /* in */ IBlackmagicRawClipGeometry* geometry,
...
public:
    virtual HRESULT GetToneCurve(
        /* in */ const char* cameraType, /* in */ const char* gamma, /* in */ uint16_t gen /* Color science gen */,
    ...
    virtual HRESULT
    EvaluateToneCurve(/* in */ const char* cameraType, /* in */ uint16_t gen, /* in */ float contrast, /* in */ float saturation,
...
public:
    ...
    virtual HRESULT SetSidecarPost3DLUT(/* in */ const char* name, /* in */ const char* title, /* in */ uint16_t size,
                                        /* in */ Variant* data) = 0;
    virtual HRESULT GetEmbeddedPost3DLUT(/* out */ IBlackmagicRawPost3DLUT** lut) = 0;
    virtual HRESULT SetEmbeddedPost3DLUT(/* in */ const char* name, /* in */ const char* title, /* in */ uint16_t size,
                                         /* in */ Variant* data) = 0;
...
public:
    ...
    virtual HRESULT WriteCubeFile(/* in */ const char* filePath) = 0;
...
public:
    ...
    virtual void SidecarMetadataParseWarning(/* in */ IBlackmagicRawClip* clip, /* in */ const char* fileName, /* in */ uint32_t lineNumber,
                                             /* in */ const char* info) = 0; // offending line will be ignored
    virtual void SidecarMetadataParseError(/* in */ IBlackmagicRawClip* clip, /* in */ const char* fileName, /* in */ uint32_t lineNumber,
                                           /* in */ const char* info) = 0; // entire file will be ignored
...
{
public:
    virtual HRESULT OpenCompanionFile(/* in */ IBlackmagicRawFile* parentFile, /* in */ const char* fileName,
                                      /* out */ IBlackmagicRawFile** fileOut) = 0;
    virtual HRESULT CreateCompanionFile(/* in */ IBlackmagicRawFile* parentFile, /* in */ const char* fileName,
...
public:
    ...
    virtual HRESULT GetFileName(/* out */ const char** fileName) = 0;
...
public:
    ...
    virtual HRESULT SetMetadata(/* in */ const char* key,
...
public:
    ...
    virtual HRESULT CreateJobTrim(/* in */ const char* filePath, /* in */ uint64_t frameIndex, /* in */ uint64_t frameCount,
