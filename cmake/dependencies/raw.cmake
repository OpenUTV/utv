...
IF(NOT TARGET LibRaw::raw)
  ...
  FIND_PATH(
    ...
    HINTS ${LIBRAW_INCLUDEDIR} ${LIBRAW_INCLUDE_DIRS}
  )
  IF(LIBRAW_INCLUDE_DIR)
    TARGET_INCLUDE_DIRECTORIES(
      LibRaw::raw
      INTERFACE "${LIBRAW_INCLUDE_DIR}"
    )
  ENDIF()
ENDIF()

IF(DEFINED LIBRAW_VERSION)
...
ELSEIF(DEFINED LIBRAW_VERSION_STRING)
  SET(RV_DEPS_RAW_VERSION
