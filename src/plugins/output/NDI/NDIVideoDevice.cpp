...
namespace NDI
{
    ...
    void NDIVideoDevice::PBOData::unlockData() { pthread_mutex_unlock(&mutex); }
    ...
    size_t NDIVideoDevice::asyncMaxMappedBuffers() const { return m_pboSize; }
    ...
    size_t NDIVideoDevice::numSyncModes() const { return syncModes.size(); }
    ...
    bool NDIVideoDevice::isOpen() const { return m_isOpen; }
    ...
    bool NDIVideoDevice::willBlockOnTransfer() const { return false; }

    bool NDIVideoDevice::readyForTransfer() const { return true; }
