...
namespace AJADevices
{
    ...
    //  independent state machine. The states are defined in terms of the
    //  sequence of events when using PBOs. For pinned buffers and
    //  glReadPixels() alone, the un/mapping states are basically no-ops. The
    //  state progesses like this:
    //
