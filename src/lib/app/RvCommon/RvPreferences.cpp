...
namespace Rv
{
        ...
        , m_videoLatencyDialog(0)
    {
        ...
        connect(m_ui.useNativeFileDialogToggle, SIGNAL(stateChanged(int)), this, SLOT(useNativeFileDialogChanged(int)));
...
// Only connect the update slot to the architecture appropriate signal
    ...
    void RvPreferences::update()
    {
        ...
        m_ui.useNativeFileDialogToggle->setCheckState(opts.useNativeFileDialog ? Qt::Checked : Qt::Unchecked);
    ...
    void RvPreferences::loadSettingsIntoOptions(RvSettings& settings, Options& opts)
    {
        ...
        opts.useNativeFileDialog = int(settings.value("useNativeFileDialog", opts.useNativeFileDialog ? true : false).toBool());
