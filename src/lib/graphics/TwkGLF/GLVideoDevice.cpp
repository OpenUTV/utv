...
namespace TwkGLF
{
    ...
    VideoDevice::Timing GLVideoDevice::timing() const { return Timing(0.0); }
    ...
    GLenum internalFormatFromDataFormat(VideoDevice::InternalDataFormat f)
    {
        switch (f)
        {
    ...
    GLenumPair textureFormatFromDataFormat(VideoDevice::InternalDataFormat f)
    {
        switch (f)
        {
        case VideoDevice::RGB8:
        ...
        case VideoDevice::BGRA8:
            return GLenumPair(GL_BGRA, GL_UNSIGNED_BYTE);
        case VideoDevice::RGB16:
        ...
        case VideoDevice::RGB10X2Rev:
            return GLenumPair(GL_RGBA, GL_UNSIGNED_INT_2_10_10_10_REV);
        case VideoDevice::RGB16F:
