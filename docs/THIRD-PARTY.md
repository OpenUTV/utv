...
The Blackmagicdesign&reg; SDK is NOT provided by UTV. It can be optionally downloaded from <https://www.blackmagicdesign.com/desktopvideo_sdk> after agreeing to its license agreement.<br>
...
The NDI&reg; SDK is NOT provided by UTV. It can be optionally downloaded from <https://ndi.video/> and installed after agreeing to its license agreement.<br>
