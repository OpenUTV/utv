...
reg add "HKCR\Applications\utvpush.exe\shell\open\command" /ve /d "\"%utvpushExePath%\" -tag \"openwith\" \"merge\" \"%%1\"" /f
...
reg add "HKCR\Applications\rvpush.exe\shell\open\command" /ve /d "\"%utvpushExePath%\" -tag \"openwith\" \"merge\" \"%%1\"" /f
